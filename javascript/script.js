...
if(edad > 18){
 ...
 const dia = 1
 switch(dia){
    case 1: console.log ('Día lunes'); break //breaek:ejecuta el caso seleccionado
    //un caso, se escribe lo que va a pasar
    case 2:console.log ('Día martes'); break 
    default:console.log('Día no registrado'); //default por defecto 
 }
...
const miArreglo =[1,2,"jiji", true]; //son posiciones, si tiene corchete es una lista o arreglo
